...
public class UserATM_lmpl implements UserATM{
    ...
    private static UserATM_lmpl userImpl = new UserATM_lmpl();
    public static UserJoin_Impl userJoin = new UserJoin_Impl();

    public static UserATM_lmpl getInstance() {
        if(userImpl == null) {
            userImpl = new UserATM_lmpl();
        }
        return userImpl;
    }
    ...
    @Override
    public void userAccount(int account, String userName, int balance) {
